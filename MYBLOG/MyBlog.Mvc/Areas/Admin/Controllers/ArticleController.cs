...
namespace MyBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class ArticleController : BaseController
    {
        ...
        {
            var category = await _categoryService.GetAsync(articleAddViewModel.CategoryId);
            //ModelState.(nameof(articleAddViewModel.Categories));
        ...
        {
            ModelState.Remove(nameof(articleUpdateViewModel.ThumbnailFile));
            if (ModelState.IsValid)
            {
