$(document).ready(function () {
                ...
                action: function (e, dt, node, config) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            // yenilemeden önce dt yi etmizle
                            dataTable.clear();
                            ...
                            `
                                        ]).node(); // .node() fonskiyonu bu rowu bir table row olarak seçebilmemizi sağlar.
                                        $(newTableRow).attr('name', `${user.Id}`);;
    ...
    //Ajax POST | Posting the formdata as useradddto ens here
    // Ajax POST | Dleting a user starts from here
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    error: function (err) {
                        ...
                        Swal.fire(
                            "Başarısız",
                            `${userName} adlı kategori silinemedi.`,
                            "warning"
                        )
                    }
                })
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (isValid) {
                            ...
                            dataTable.row(tableRow).invalidate(); // datatablea girilen rowun yeni olmadığını, değiştiğini iletir.
