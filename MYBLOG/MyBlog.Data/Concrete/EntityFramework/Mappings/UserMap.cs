...
namespace MyBlog.Data.Concrete.EntityFramework.Mappings
{
    public class UserMap:IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            // Social Media Links
            builder.Property(u => u.YoutubeLink).HasMaxLength(250).IsRequired(false);
            builder.Property(u => u.TwitterLink).HasMaxLength(250).IsRequired(false);
            builder.Property(u => u.InstagramLink).HasMaxLength(250).IsRequired(false);
            builder.Property(u => u.FacebookLink).HasMaxLength(250).IsRequired(false);
            builder.Property(u => u.LinkedInLink).HasMaxLength(250).IsRequired(false);
            builder.Property(u => u.GitHubLink).HasMaxLength(250).IsRequired(false);
            builder.Property(u => u.WebsiteLink).HasMaxLength(250).IsRequired(false);
            // About
